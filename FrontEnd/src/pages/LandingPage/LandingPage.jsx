...
const LandingPage = () => {
  ...
  />
  <p className="ATS-text">Companies receive thousands of applications for each of their advertised positions.
  Not all of the resumes sent will be looked at by hiring managers; instead, companies use an Applicant Tracking System (ATS),
  which scans all resumes and then decides if your resume is worth being passed on to a recruiter.
   Some of them simply search for keywords while organizing candidates' documents, making them searchable.
   Other ones use artificial intelligence for an even deeper analysis. These artificial intelligence models analyze
   past choices of the company to learn about the characteristics of desired employees. Even though each organization's
   selected employees are different according to its culture and values, all organizations have standard features that
   they look for in a candidate.</p>
  </div>
  <div>
  <p className="our-text">Our system ensures that you get through the Applicant Tracking
  System using AI's power and gives you the chance to have your resume checked by a recruiter.
