    ...
    <ResumeContext.Consumer>
             {(context) => {
               if(context.result == null && !context.loading){
                 history.push('/');
                 return;
               } else if(context.results == null && context.loading){
                 return(<div id="searching-animation" style={{minHeigth: "800px", marginTop: "60px"}}>
                 <Lottie
          	    options={options}
                  height={600}
                  width={600}
                />
                 ...
                 return (
                   <div style={{height: "650px", marginLeft: "35%", marginTop:"100px", fontSize:"30px"}}>
                     <h2>File Details:</h2>
